...
class  TextCNN_GCN(object):
    ...
    def __init__(
        ...
        placeholders, input_dim, 
        bioasq_embed, umls_embed, umls_embedding_size, **kwargs):
        ...
        if bioasq_embed is None:
            ...
            with tf.device('/cpu:0'), tf.name_scope("embedding"):
                ...
                self.embedded_chars_expanded = tf.expand_dims(self.embedded_chars, -1, name="BioASQ_embedded_chars_expanded")
